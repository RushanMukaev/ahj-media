...
export default class DataForm {
    ...
    showPosition(position) {
        ...
        const dataGeoPosition = document.querySelectorAll('.data-geo-position');
    ...
    getDataInput(e) {
        ...
        const data = e.target.closest('.content-modal').querySelector('.enter-data').value;
...
дайте разрешение на использование геолокации, либо введите координаты вручную</p><p>Широта и долгота через запятую</p>`;
        ...
        const dataCoords = document.querySelector('.enter-data');
    ...
    init() {
        this.userMessage = this.container.querySelector('.message');
